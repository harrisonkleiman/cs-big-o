...
// ANSWER: I think the time complexity is O(n) because it has to loop through the string once to get the length of the string, and then it has to loop through the string again to count the letters.
...
// ANSWER:  Yes by using the spread operator to make a copy of the array.
...
// ANSWER: I came to the conclusion that the space complexity of countLettersRoundTwo is 0(1) because it only has one variable, letters while countLetters has a variable for each letter.
